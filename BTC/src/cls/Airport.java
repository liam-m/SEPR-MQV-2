...
public class Airport extends Waypoint implements EventHandler {
	...
	public boolean isWithinDepartures(Vector position) {
		return isWithinRect((int)position.x(), (int)position.y(), (int)(departures_x_location-airport.width()/2) + Demo.airspace_view_offset_x, (int)(departures_y_location-airport.height()/2) + Demo.airspace_view_offset_y, (int)departures_width, (int)departures_height);
	}
