...
public class AirportTest {
	...
	public void testIsMouseInRect() {
		...
		assertTrue("(10, 10) is in the rectangle", test_airport.isMouseInRect(test_x, test_y, x, y, width, height));
	
		test_x = 0;
		test_y = 0;
		assertTrue("(0, 0) is in the rectangle", test_airport.isMouseInRect(test_x, test_y, x, y, width, height));

		test_x = -10;
		test_y = 0;
		assertFalse("(-10, 0) is not in the rectangle", test_airport.isMouseInRect(test_x, test_y, x, y, width, height));

		test_x = 0;
		test_y = -10;
		assertFalse("(0, -10) is not in the rectangle", test_airport.isMouseInRect(test_x, test_y, x, y, width, height));

		test_x = 25;
		test_y = 0;
		assertFalse("(25, 0) is in the rectangle", test_airport.isMouseInRect(test_x, test_y, x, y, width, height));
		
		test_x = 0;
		test_y = 25;
		assertFalse("(0, 25) is in the rectangle", test_airport.isMouseInRect(test_x, test_y, x, y, width, height));
	}
